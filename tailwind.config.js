  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'card-hover': '0 4px 6px -1px rgb(15 23 42 / 0.1), 0 2px 4px -2px rgb(15 23 42 / 0.06)',
        'elevated': '0 10px 15px -3px rgb(15 23 42 / 0.08), 0 4px 6px -4px rgb(15 23 42 / 0.05)',
        'glow': '0 0 0 3px rgb(59 130 246 / 0.12)'
      },
      animation: {
      ...
      backgroundImage: {
        ...
        'shimmer': 'linear-gradient(90deg, #f1f5f9 0%, #e2e8f0 50%, #f1f5f9 100%)'
      }
    }
  },
  plugins: []
